                        ...
                        <ul class="menu-list">
                            <li class="menu-item has-children">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li class="sub-menu-item">
                                        <a href="{{route('admin.product.products')}}" class="">
                                            <div class="text">Products</div>
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <li class="menu-item has-children">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li class="sub-menu-item">
                                        <a href="{{route('admin.brand.brands')}}" class="">
                            ...
                            <li class="menu-item has-children">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li class="sub-menu-item">
                                        <a href="{{route('admin.category.categories')}}" class="">
                            ...
                            <li class="menu-item">
                                <a href="{{route('admin.coupon.coupons')}}" class="">
                                    <div class="icon"><i class="icon-grid"></i></div>
...
@yield('content')
                    ...
                    <div class="bottom-page">
                        <div class="body-text">Copyright © 2025 SHOPIA</div>
                    </div>
                </div>
