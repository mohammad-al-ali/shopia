                        ...
                        <div class="wg-chart-default mb-20">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        <div class="body-text mb-2">Processing Orders</div>
                                        <h4>{{$dashboardData->TotalProcessing}}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        ...
                                        <h4>{{$dashboardData->TotalProcessingAmount}}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="mb-2">
                                <div class="block-legend">
                                    ...
                                    <div class="text-tiny">Processing</div>
                                </div>
                            </div>
                            <div class="flex items-center gap10">
                                <h4>${{$TotalProcessingAmount}}</h4>
                            </div>
                        </div>
                   <div>
                            <div class="mb-2">
                ...
                <div class="wg-box">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="dropdown default">
                            <a class="btn btn-secondary dropdown-toggle" href="{{route('admin.order.orders')}}">
