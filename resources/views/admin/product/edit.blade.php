                        ...
                        <fieldset>
                            ...
                            <div class="upload-image flex-grow">
                                ...
                                <div class="item" id="imgpreview" >
                                    <img src="{{asset('storage/products_image/' . $product->image)}}" class="effect8" alt="{{$product->name}}">
                                </div>
                                @endif
                            ...
                            <div class="upload-image mb-16">
                                @if($product->images)
                                    @foreach(explode(',',$product->images) as $img)
                                     ...
                                     <img src="{{asset('storage/products_image/gallery/' . $img)}}" alt="{{$product->name}}">
                                 </div>
                                    @endforeach
                                @endif
                        ...
                        <div class="cols gap22">
                            <fieldset class="warehouse_price">
                                ...
                                <input class="mb-10" type="number" step="0.01" placeholder="Enter Warehouse Price"
                                       name="warehouse_price" tabindex="0" value="{{$product->warehouse_price}}" aria-required="true">
                            </fieldset>
