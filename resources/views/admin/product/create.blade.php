...
{{--                           autocomplete="off">--}}
                    ...
                    <div class="wg-box">
                        ...
                        <fieldset class="short_description">
                            ...
                            <textarea class="mb-10 ht-150" name="short_description"
                                      placeholder="Short Description" tabindex="0" >{{old('short_description')}}</textarea>
                            <div class="text-tiny">Do not exceed 100 characters when entering the
                                product name.</div>
                        </fieldset>
                ...
                <img src="images/upload/upload-1.png" alt="">
                        ...
                        <div class="cols gap22">
                            <fieldset class="warehouse_price">
                                <div class="body-title mb-10">Warehouse Price<span
                                        class="tf-color-1">*</span></div>
                                <input class="mb-10" type="number" step="0.01" placeholder="Enter Warehouse Price"
                                       name="warehouse_price" tabindex="0" value="{{old('warehouse_price')}}" aria-required="true">
                            </fieldset>
                            ...
                            <fieldset class="sale_price">
                                <div class="body-title mb-10">Sale Price <span
                                        class="tf-color-1">*</span></div>
                                <input class="mb-10" type="number" step="0.01" placeholder="Enter sale price"
                        ...
                        <div class="cols gap22">
                            <fieldset class="quantity">
                                ...
                                <input class="mb-10"  type="number" step="1" placeholder="Enter quantity"
        ...
        @push('scripts')
            ...
            $("#galUpload").html(""); // مسح الصور القديمة
            $.each(files, function(index, file){
            $("#galUpload").append(<div class="item"><img src="${URL.createObjectURL(file)}" width="100px" /></div>);
            });
            });
            });
            </script>
