            ...
            <div class="tab-pane fade show active" id="tab-item-register" role="tabpanel" aria-labelledby="register-tab">
                <div class="register-form">
                    <form method="POST" action="{{ route('register') }}" name="register-form" class="needs-validation" novalidate="">
                        ...
                        <div class="form-floating mb-3">
                            <input id="phone" type="text" class="form-control form-control_gray  @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}"
                        ...
                        <div class="form-floating mb-3">
                            <input id="address" type="text" class="form-control form-control_gray  @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}"
