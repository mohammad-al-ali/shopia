                ...
                <div class="col-lg-7">
                    <div class="product-single__media" data-media-type="vertical-thumbnail">
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide product-single__image-item">
                                        <img loading="lazy" class="h-auto" src="{{asset('storage/products_image/' . $product->image)}}" alt="{{$product->name}}" width="674"
                                             height="674"/>

                                        <a data-fancybox="gallery" href="{{asset('storage/products_image/' . $product->image)}}" data-bs-toggle="tooltip"
                                    ...
                                    @foreach(explode(',',$product->images) as $img)
                                        <div class="swiper-slide product-single__image-item">
                                        <img loading="lazy" class="h-auto" src="{{asset('storage/products_image/gallery/' . $img)}}" width="674"
                                             height="674" alt="" />
                                        <a data-fancybox="gallery" href="{{asset('storage/products_image/gallery/' . $img)}}" data-bs-toggle="tooltip"
                                           data-bs-placement="left" title="Zoom">
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <use href="#icon_zoom" />
                                            </svg>
                        ...
                        <div class="product-single__thumbnail">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto" src="{{asset('storage/products_image/' . $product->image)}}" alt="{{$product->name}}"width="104" height="104" /></div>
                                    @foreach(explode(',',$product->images) as $img)
                                    <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto" src="{{asset('storage/products_image/gallery/' . $img)}}" width="104" height="104" alt="" /></div>
                                    @endforeach
                                </div>
                            </div>
                        </div>
                ...
                "spaceBetween": 30
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide product-card" >
                            <div class="pc__img-wrapper" {{route('product.details',['slug'=>$rproduct->slug])}}>
                                <a href="{{route('product.details',['slug'=>$rproduct->slug])}}">
                                    <img  loading="lazy" src="{{asset('storage/products_image/' . $rproduct->image)}}" width="330" height="400" alt="{{$rproduct->name}}">
                                    @foreach(explode(',',$rproduct->images) as $img)
                                        <img loading="lazy" src="{{asset('storage/products_image/gallery/' . $img)}}"  alt="{{$rproduct->name}}" class="pc__img pc__img-second"></a>
                                @endforeach
                            ...
                            <div class="pc__info position-relative">
                                ...
                                <h6 class="pc__title"><a href="{{route('product.details',['slug'=>$rproduct->slug])}}">{{$rproduct->name}}</a></h6>
